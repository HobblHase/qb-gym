...
ConfigGym.Locations = {
    [1] = {--pull-ups
        ...
        Text3D = "~g~[E]~w~ - Do chin-ups", viewDistance = 2.5,
    },
    [2] = {--arms
        ...
        Text3D = "~g~[E]~w~ - Use weights", viewDistance = 2.5,
    },
    [3] = {--pushup
